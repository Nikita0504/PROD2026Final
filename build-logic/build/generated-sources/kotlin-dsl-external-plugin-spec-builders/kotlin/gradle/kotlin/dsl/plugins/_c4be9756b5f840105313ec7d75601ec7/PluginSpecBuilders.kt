...
package gradle.kotlin.dsl.plugins._c4be9756b5f840105313ec7d75601ec7
...
/**
 * The `androidx.room` plugin implemented by [androidx.room.gradle.RoomGradlePlugin].
 */
internal
val `AndroidxPluginGroup`.`room`: PluginDependencySpec
    get() = plugins.id("androidx.room")
